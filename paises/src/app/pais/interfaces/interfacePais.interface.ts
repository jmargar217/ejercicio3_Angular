...
export interface SearchPaisInterface {
  name:         Pais;
  tld:          string[];
  cca2:         string;
  ccn3:         string;
...
export class Convert {
  public static toWelcome(json: string): SearchPaisInterface[] {
      return cast(JSON.parse(json), a(r("Welcome")));
  }

  public static welcomeToJson(value: SearchPaisInterface[]): string {
